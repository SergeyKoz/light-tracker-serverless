...
namespace LightTrackerServerless;
...
public class Startup
{
    ...
    public void ConfigureServices(IServiceCollection services)
    {
        ...
        var repositoryType = Environment.GetEnvironmentVariable("REPOSITORY_TYPE") ?? "database";

        if (repositoryType != null && repositoryType == "memory")
        {
            services.AddScoped<IDeviceRepository, InMemoryRepository>();
        }
        else
        {
            services.AddDbContext<LightTrackerContext>();
